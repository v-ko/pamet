...
int error=0; //za sybirane na gre6ki
int dbg=0;
...
//Ako x e izvyn range-a min-max go vry6ta na syotvetnata granica
float stop(float x,float min, float max)
{
    if (x<min) {
...
/* TOVA E ARHIV (I GORNATA IZGLEJDA6E TAKA :D
