...
export function parseUrl(url: string): PametRoute {
...
export function toUrlPath(route: PametRoute): string {
    let path = '/';
    ...
    let projectScopedPath = toProjectScopedPath(route);
